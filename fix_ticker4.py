...
import re
old_pattern = r'<div style=["\']?background:#c0392b.*?</style></div>'
...
if result != content:
    ...
    # Mostra i primi 200 caratteri dopo c0392b per capire la struttura
    idx = content.find('background:#c0392b')
    print("STRUTTURA TROVATA:", repr(content[idx-20:idx+200]))
